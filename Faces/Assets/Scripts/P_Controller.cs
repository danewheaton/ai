...
// dane's all-purpose first-person rigidbody-based character controller
...
public class P_Controller : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // there is a bug that sometimes causes the player to turn constantly after they bump into something, unless we crank up the angular drag
        myRigidbody.angularDrag = 20;
